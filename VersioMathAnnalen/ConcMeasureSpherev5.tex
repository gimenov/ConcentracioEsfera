...
\thanks{Research partially supported by the Research Program of University Jaume I Project UJI-B2021-08, and and Research grant  PID2020-\-115930\-GA-100 funded by MCIN/ AEI /10.13039/501100011033}


\subjclass[2020]{Primary 58C35, 49Q15, 53A10}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.35]{banda.eps}
...
\begin{remark}
 ...
 \begin{figure}
     \centering
     \includegraphics[scale=0.4]{dosbandes.eps}
...
Let  $x: \Sigma^m \to \mathbb{S}^n(1)$ be an isometric and minimal immersion of the closed $m$-dimensional manifold $\Sigma$ in the sphere  $\mathbb{S}^n(1)$. Then, for any point $p \in \mathbb{S}^n(1)$ , any  $\epsilon \in (0,\pi/2)$ and any  absolute $\delta\in [0,\frac{1}{2})$, (in the sense that does not depend on $n$), we have 
